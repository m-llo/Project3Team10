...
function savedRecipeList({data, addBtn, delBtn}){
return (
<div className="p-1 m-1">
<h6 className="fs-2 fw-normal">{data.label}</h6>
    <div className="row justify-items-around">
   <div className="col">
    <button className="btn btn-outline-success p-1 .text-wrap"  id={data.id} value={data} onClick={addBtn} name="add">Add to Plan</button>
    </div>
    <div className="col">
